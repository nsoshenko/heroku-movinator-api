...
import { MoviePredicate } from "./types/types";
...
// Wrapper around utility function combinePredicate for meaningful export
export const reproduceStatePredicate = (predicates: MoviePredicate[]) =>
